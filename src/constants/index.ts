// 定义一个公共常量，不止一处用到
export const SYSTEM_LOGO = "https://wbe-tilas.oss-cn-hangzhou.aliyuncs.com/%E5%84%BF%E7%AB%A5%E6%91%84%E5%83%8F%E5%B8%88%20%281%29.png";
/**
 * 知识星球文档地址
 */
 ...
 * 默认头像
 */
export const DEFAULT_AVATAR_URL = 'https://wbe-tilas.oss-cn-hangzhou.aliyuncs.com/Panda2.png';
...
export const selectAvatarUrl = [
  { value: 'https://wbe-tilas.oss-cn-hangzhou.aliyuncs.com/Dogyupi.jpg', label: '美女' },
  { value: 'https://wbe-tilas.oss-cn-hangzhou.aliyuncs.com/Dogyupi.jpg', label: '猫咪' },
  { value: 'https://wbe-tilas.oss-cn-hangzhou.aliyuncs.com/Dogyupi.jpg', label: '功夫猫咪' },
  {
    value:
